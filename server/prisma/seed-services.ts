...
const services: {
  ...
  },
  {
    ...
    fullDescription: "Надаємо послуги евакуатора для перевезення несправних, пошкоджених або заблокованих автомобілів. Працюємо по Львову та Львівській області, виїжджаємо на ДТП, поломки в дорозі, допомагаємо з доставкою авто на СТО, стоянку або за вказаною адресою. Подача здійснюється після узгодження деталей, а вартість залежить від відстані, типу транспорту та складності навантаження.",
    image: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920",
    priceInfo: "Вартість розраховується індивідуально залежно від відстані та типу авто",
    pricingType: "custom",
    relatedEquipmentTypes: ["other"],
    ...
    seoDescription: "Замовте евакуатор у Львові та Львівській області. Виїзд на місце, перевезення авто після ДТП, поломки або на СТО.",
    sortOrder: 11,
  },
];
